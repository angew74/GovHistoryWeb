...
namespace GovHistoryRepository.Identity
{
    ...
    {
        public ApplicationUserStore(GovHistoryDbContext context)
            : base(context)
        {
        }
    }
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new ApplicationUserStore(context.Get<GovHistoryDbContext>()));
        ...
        {
            return GetUser(new GovHistoryDbContext(), _userId);
        }
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole, int>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<ApplicationRole, int, ApplicationUserRole>(context.Get<GovHistoryDbContext>()));
        }
        ...
        public static bool CreateRole(ApplicationRole _role)
        {
            ...
            try
            {
                var roleManager = new RoleManager<ApplicationRole, int>(new RoleStore<ApplicationRole, int, ApplicationUserRole>(new GovHistoryDbContext()));
