...
namespace GovHistoryRepository.Identity
{
    ...
    public class GovHistoryDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, int, ApplicationUserLogin, ApplicationUserRole, ApplicationUserClaim>
    {
        ...
        public static GovHistoryDbContext Create()
        {
            return new GovHistoryDbContext();
        }
